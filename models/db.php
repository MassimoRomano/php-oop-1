...
$film2 = new Production('The Godfather', 'English', 9.2, 'https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmUtYTAwNi00MTYxLWJmNWYtYzZlODY3ZTk3OTFlXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg');
...
foreach ($films as $film) {
    echo ''.$film->titolo .' <br/> '.$film->lingua.' <br/> '.$film->voto. ' <br/> '.$film->poster.' <br/> ';
}